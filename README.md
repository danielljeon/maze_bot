...
* [maze_bot](#maze_bot)
  ...
  * [2 Maze Navigation](#2-maze-navigation)
    * [2.1 Navigation Pathing Logic](#21-navigation-pathing-logic)
    * [2.2 Python Maze Definition and Solver](#22-python-maze-definition-and-solver)
<!-- TOC -->
...
Maze pathing is handled by the
centralized [state_machine.c](Core/Src/state_machine.c).

While the general states are hardcoded, each state's actions are/can be handled
in a closed-loop way and generated by maze searching algorithms.

- For example, maze corridor parallel travel is defined
  within [maze_navigation.c](Core/Src/maze_navigation.c).

### 2.2 Python Maze Definition and Solver

Automated maze definition and solving is completed in python, found in
the [pathing](docs/pathing) directory.

Primary file execution is completed by
calling [main.py](docs/pathing/main.py), for example:
